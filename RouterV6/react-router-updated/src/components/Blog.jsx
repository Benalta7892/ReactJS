  ...
  return (
    <>
      ...
      <main className="container">
        ...
        <div className="row g-5">
          <div className="col-md-8">
            <h3 className="pb-4 mb-4 fst-italic border-bottom">Lorem ipsum, dolor sit amet</h3>
            ...
            {articleArray.map((article) => (
              <article className="blog-post" key={article.id}>
                ...
                <p className="blog-post-meta">
                  January {article.id}, 2021 par <a href="#">DonkeyGeek</a>
                </p>
            ...
            <div className="position-sticky" style={{ top: "2rem" }}>
              ...
              <div className="p-4">
                ...
                <ol className="list-unstyled mb-0">
                  ...
                  <li>
                    <a href="#">Janvier 2021</a>
                  </li>
                  <li>
                    <a href="#">Décembre 2020</a>
                  </li>
                  <li>
                    <a href="#">Novembre 2020</a>
                  </li>
                  <li>
                    <a href="#">Octobre 2020</a>
                  </li>
                  <li>
                    <a href="#">Septembre 2020</a>
                  </li>
                  <li>
                    <a href="#">Aout 2020</a>
                  </li>
                  <li>
                    <a href="#">Juillet 2020</a>
                  </li>
                  <li>
                    <a href="#">Juin 2020</a>
                  </li>
      ...
      <footer className="blog-footer">
        <p>
          <a href="https://getbootstrap.com/">Template via Bootstrap</a>
        </p>
        <p>
