    ...
    quizz: {
      ...
      confirme: [
        ...
        },
        {
          ...
          options: ["Le diable motard", "L'esprit de la haine", "L'esprit de vengeance", "Le crâne rouge"],
      ...
      expert: [
        {
          ...
          options: ["Séduire Iron-Man", "Séduire Spider-Man", "Tuer The Black Widow", "Tuer Nick Fury"],
        ...
        },
        {
          ...
          options: ["The Valley of Spirits", "The Mountains of Asgard", "The Canyons of Atlantis", "The Cave of Souls"],
